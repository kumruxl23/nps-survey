...
def _item_to_org_config(item: dict) -> OrgConfig:
    ...
    return OrgConfig(
        ...
        custom_field_feedback_gid=item.get("custom_field_feedback_gid", ""),
        custom_field_what_missing_gid=item.get("custom_field_what_missing_gid", ""),
        custom_field_respondent_name_gid=item.get("custom_field_respondent_name_gid", ""),
        custom_field_respondent_email_gid=item.get("custom_field_respondent_email_gid", ""),
...
def put_org(org: OrgConfig) -> None:
    ...
    item = {
        ...
        "custom_field_feedback_gid": org.custom_field_feedback_gid,
        "custom_field_what_missing_gid": org.custom_field_what_missing_gid,
        "custom_field_respondent_name_gid": org.custom_field_respondent_name_gid,
        "custom_field_respondent_email_gid": org.custom_field_respondent_email_gid,
